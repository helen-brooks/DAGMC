if (LIBMESH_PREFIX)
  ...
  if(EXISTS ${LIBMESH_PREFIX}/bin/libmesh-config)
    ...
    execute_process(COMMAND ${LIBMESH_PREFIX}/bin/libmesh-config --cppflags --cxxflags OUTPUT_VARIABLE libMesh_CPPFLAGS OUTPUT_STRIP_TRAILING_WHITESPACE)
    ...
    message(FATAL_ERROR "Could not find libMesh. Please check if -DLIBMESH_PREFIX was set correctly.")
  endif()
